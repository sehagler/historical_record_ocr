...
def hr_main(api_key,  pdf_automated_segmentation_flg, pdf_city, pdf_year, dpi_flg, columns_per_page, 
    ...
    internal_ref_abbr_dict_both_2 = abbr_dict(False, 2, internal_ref_abbr_list_xlsx,
                                              common_ocr_errors_list_xlsx)
    hyphenated_executive_occupation_dict_both_2 = abbr_dict_occupations(False, True, 2,
    ...
    hyphenated_generic_occupation_dict_both_2 = abbr_dict_occupations(False, True, 2, 
                                                                      ...
                                                                      occupation_specifier_list_xlsx, 
                                                                      common_ocr_errors_list_xlsx)
    unhyphenated_executive_occupation_dict_both_2 = abbr_dict_occupations(False, False, 2,
                                                                          executive_occupation_list_xlsx,
                                                                          occupation_specifier_list_xlsx,
                                                                          common_ocr_errors_list_xlsx)
    ...
    generic_occupation_value_list = get_value_list_occupations(True, generic_occupation_list_xlsx,
                                                                occupation_determiner_list_xlsx,
                                                                occupation_specifier_list_xlsx)
    ...
    hr_text_segmenter2(columns_per_iteration, max_chars, sect_dir, 4, pdf_name, generic_business_value_list, 
                       executive_occupation_value_list, generic_occupation_value_list, title_key_list)
